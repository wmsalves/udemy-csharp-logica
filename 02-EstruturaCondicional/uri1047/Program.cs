...
namespace uri1047
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Informe a hora inicial, minuto final, hora final e minuto final do jogo: ");
            ...
            Console.WriteLine("O jogo teve duração de " + duracaoHoras + " hora(s) e " + duracaoMinutos + " minutos(ss)");
        }
    }
}